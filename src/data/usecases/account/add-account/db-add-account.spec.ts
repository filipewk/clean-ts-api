...
import { mockHasher, mockAddAccountRepository, mockLoadAccountByEmailRepository } from '@/data/mocks'
import { mockAccountModel, mockAddAccountParams } from '@/domain/mocks/index'
